	...
	var Instagram = {
        ...
        display: function (results) {
            ...
            if (results.data.length === 0) {
                ...
                var d = function() {
                    ...
                    self.$elem.html(
                        "<div class=\"box-header\">" +
                            "<img class=\"social-icon\" src=\"/static/common/theme/images/Instagram_logo.png\"></img>" +
                            "<span style='text-transform: uppercase; line-height: 40px'> Instagram</span>" +
                        "</div>" +
                        "<div class=\"box-body\">" +
                            "<div class=\"content\">" +
                                "<div class=\"inner\">" +
                                    "<img class=\"avatar\" src='" + results.data[i].user.profile_picture +"'>" +
                                    "<span> @" + results.data[i].user.username + "</span>" +
                                    "<br/></img><img class=\"instagram-pic\" src='" + size + "'></img>" +
                                    "<br/><br/><span class=\"instagram-text\">" + results.data[i].caption.text + "</span>"+
                                "</div>"+
                            "</div>"+
                        "</div>"+
                ...
                interval_id = setInterval(d, 7000);
            };
