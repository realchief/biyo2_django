  ...
  var _jquery2 = babelHelpers.interopRequireDefault(_jquery),
    ...
    Site = function(_Base) {
      ...
      return babelHelpers.inherits(Site, _Base), babelHelpers.createClass(Site, [{
        key: "willProcess",
        value: function() {
          this.startLoading(), this.initializePluginAPIs(), this.initializePlugins()
        }
      }, {
        key: "processed",
        value: function() {
          this.polyfillIEWidth(), this.initBootstrap(), this.setupMenubar(), this.setupFullScreen(), this.setupMegaNavbar(), this.setupWave(), this.$el.on("click", ".dropdown-menu-media", function(e) {
            e.stopPropagation()
          })
        }
      }, {
        ...
        value: function() {
          ...
          var children = [this.menubar, this.sidebar],
            $aside = (0, _jquery2.default)(".page-aside");
          return $aside.length > 0 && children.push(new _PageAside2.default({
            $el: $aside
          })), children
        }
      }, {
        ...
        value: function() {
          ...
          (0, _jquery2.default)(document).on("click", '[data-toggle="menubar"]', function() {
            ...
            return _this2.setState("menubarType", type), !1
          }), (0, _jquery2.default)(document).on("collapsed.site.menu expanded.site.menu", function() {
            var type = _this2.getState("menubarType");
            "open" === type && _this2.menubar && _this2.menubar.scrollable && _this2.menubar.scrollable.update()
        ...
        key: "setupWave",
        value: function() {
          "undefined" != typeof Waves && (Waves.init(), Waves.attach(".site-menu-item > a", ["waves-classic"]), Waves.attach(".site-navbar .navbar-toolbar a", ["waves-light", "waves-round"]), Waves.attach(".btn"))
        }
      }, {
        key: "startLoading",
        value: function() {
          return "undefined" != typeof _jquery2.default.fn.animsition && void $BODY.animsition({
            inClass: "fade-in",
            inDuration: 800,
            loading: !0,
